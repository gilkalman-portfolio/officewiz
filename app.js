...
(async function () {
  ...
  const testimonials = [
    ...
    { text: "שירותיות מדהימה, תמיד זמינה ומדויקת. הרו״ח שלי מעיר בכל פגישה כמה החומרים מסודרים.", name: "מיכל ד.", role: "יועצת ארגונית עצמאית" },
    { text: "חסכתי שעות בחודש ומצאתי שקט נפשי. שלומית לוקחת אחריות ועושה — בלי לרדוף אחריה.", name: "אורן ל.", role: "מנהל סטארטאפ" },
